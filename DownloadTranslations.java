...
public class DownloadTranslations {
    ...
    private static final String GITHUB_LANGS_API_URL = "https://api.github.com/repos/<username>/<repository>/contents/langs";
    private static final String LOCAL_LANGS_PATH = "path/to/example/folder";
    ...
    public static void downloadTranslations() {
        ...
        for (String lang : availableLanguages) {
            ...
            downloadTranslationFile("https://raw.githubusercontent.com/<username>/<repository>/master/langs/" + lang + ".yml", filePath);
        }
    }
